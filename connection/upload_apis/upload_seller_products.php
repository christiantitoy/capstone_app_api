...
try {
    ...
    $folder = 'capstone_app_images/seller_products';  // Clean, simple path
    $publicId = uniqid('products_', true); // Unique ID for each image
    ...
    $uploadOptions = [
        ...
        'quality' => 'auto',
        'fetch_format' => 'auto',
        'tags' => ['seller_products', 'capstone_app_images'] // Removed date from tags
    ];
