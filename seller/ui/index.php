...
<body>
    ...
    <section class="stats">
        <div class="container">
            <div class="stats-container">
                ...
                <div class="stat-item"><h3>10,000+</h3><p>Monthly Orders</p></div>
                <div class="stat-item"><h3>50+</h3><p>Barangays Served</p></div>
    ...
    <section id="features" class="features-section">
        <div class="container">
            <div class="section-title">
                <h2>Why Choose PalitOra?</h2>
                <p>The complete e-commerce solution built for local Dumaguete businesses</p>
            </div>
            <div class="features-grid">
                <div class="feature-card">
                    <div class="feature-icon"><i class="fas fa-tachometer-alt"></i></div>
                    <h3>Smart Dashboard</h3>
                    <p>Real-time insights, sales analytics, and inventory at your fingertips.</p>
                </div>
                <div class="feature-card">
    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        function updateView() {
            ...
            yearlyPlans.classList.toggle('active', isYearly);
        }

        if (monthlyRadio && yearlyRadio && monthlyPlans && yearlyPlans) {
            monthlyRadio.addEventListener('change', updateView);
